...
public class PixelArtFilter extends Filter {
  ...
  private float pixelResolution = 1000;
  ...
  public void write(JmeExporter ex) throws IOException {
    ...
    oc.write(paletteType, "paletteType", PALETTE_TYPE_LINEAR);
    oc.write(edgeWidth, "edgeWidth", 1.0f);
    oc.write(colorSize, "colorSize", 4.0f);
    oc.write(colorCount, "colorCount", 5.0f);
    oc.write(edgeIntensity, "edgeIntensity", 1.0f);
    oc.write(edgeColor, "edgeColor", ColorRGBA.Black);
    oc.write(pixelResolution, "pixelResolution", 1000f);
  ...
  public void read(JmeImporter im) throws IOException {
    ...
    paletteType = (Integer) ic.readInt("paletteType", PALETTE_TYPE_LINEAR);
    edgeWidth = (Float) ic.readFloat("edgeWidth", 1.0f);
    colorSize = (Float) ic.readFloat("colorSize", 4.0f);
    colorCount = (Float) ic.readFloat("colorCount", 5.0f);
    edgeIntensity = (Float) ic.readFloat("edgeIntensity", 1.0f);
    edgeColor = (ColorRGBA) ic.readSavable("edgeColor", null);
    pixelResolution = (Float) ic.readFloat("pixelResolution", 1000f);

    normalThreshold = (Float) ic.readFloat("normalThreshold", 0.5f);
    depthThreshold = (Float) ic.readFloat("depthThreshold", 0.1f);
    normalSensitivity = (Float) ic.readFloat("normalSensitivity", 1.0f);
    depthSensitivity = (Float) ic.readFloat("depthSensitivity", 10f);
